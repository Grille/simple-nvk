...
export const COMMAND_QUEUE_DEVICE = 0;
export const COMMAND_QUEUE_COMPUTE = 1;
export const COMMAND_QUEUE_TRANSFER = 2;
...
export const CULL_MODE_ALL = nvk.VK_CULL_MODE_FRONT_AND_BACK;
...
export const BUFFER_USAGE_STORAGE_TEXEL = nvk.VK_BUFFER_USAGE_STORAGE_TEXEL_BUFFER_BIT;
export const BUFFER_USAGE_UNIFORM_TEXEL = nvk.VK_BUFFER_USAGE_UNIFORM_TEXEL_BUFFER_BIT;

export const BUFFER_STAGING_DYNAMIC = 0;
export const BUFFER_STAGING_STATIC = 1;

export const DESCRIPTOR_TYPE_STORAGE = nvk.VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
export const DESCRIPTOR_TYPE_UNIFORM = nvk.VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
...
export const SHADER_STAGE_TESSELLATION_CONTROL = nvk.VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT;
export const SHADER_STAGE_TESSELLATION_EVALUATION = nvk.VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT;
